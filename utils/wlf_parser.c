#include "wlf/utils/wlf_parser.h"
...
static bool handle_option(const struct wlf_option *option, char *value) {
	char* p;
...
static bool long_option(const struct wlf_option *options, int count, char *arg) {
	int k, len;
...
static bool long_option_with_arg(const struct wlf_option *options, int count, char *arg,
	char *param) {
	int k, len;
...
static bool short_option(const struct wlf_option *options, int count, char *arg) {
	int k;
...
static bool short_option_with_arg(const struct wlf_option *options, int count, char *arg, char *param) {
	int k;
...
static struct wlf_config_entry *config_section_get_entry(struct wlf_config_section *section,
	const char *key) {
	struct wlf_config_entry *e;
...
void wlf_print_options_help(const struct wlf_option *options, int count, const char *appname) {
	...
	for (int i = 0; i < count; ++i) {
		const struct wlf_option *opt = &options[i];
...
int wlf_config_section_get_string(struct wlf_config_section *section, const char *key,
...
int wlf_config_section_get_bool(struct wlf_config_section *section,
