...
WLF_DEFINE_SHAPE_NODE(line_node, wlf_line_node,
	wlf_scene_node_is_line, wlf_line_node_from_node, scene_node_render)
...
static void render_at(struct wlf_line_node *node,
...
static void scene_node_render(struct wlf_render_list_entry *entry,
	...
	render_at(wlf_line_node_from_node(entry->node), data->scene->line_pass,
