...
struct wlf_curve_quint *wlf_curve_in_quint_create(void) {
...
struct wlf_curve_quint *wlf_curve_out_quint_create(void) {
	struct wlf_curve_quint *curve = malloc(sizeof(*curve));
	if (curve == NULL) {
		wlf_log_errno(WLF_ERROR, "failed to allocate wlf_curve_quint");
		return NULL;
...
struct wlf_curve_quint *wlf_curve_in_out_quint_create(void) {
	struct wlf_curve_quint *curve = malloc(sizeof(*curve));
	if (curve == NULL) {
		wlf_log_errno(WLF_ERROR, "failed to allocate wlf_curve_quint");
		return NULL;
...
struct wlf_curve_quint *wlf_curve_out_in_quint_create(void) {
	struct wlf_curve_quint *curve = malloc(sizeof(*curve));
	if (curve == NULL) {
		wlf_log_errno(WLF_ERROR, "failed to allocate wlf_curve_quint");
		return NULL;
