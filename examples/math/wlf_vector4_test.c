...
int main(int argc, char *argv[]) {
	...
	struct wlf_vector4 v1 = wlf_vector4_create(3.0, 4.0, 5.0, 6.0);
	struct wlf_vector4 v2 = wlf_vector4_create(-2.5, 1.5, -3.0, 2.0);
	...
	struct wlf_vector4 v1_copy = wlf_vector4_create(3.0, 4.0, 5.0, 6.0);
	struct wlf_vector4 v1_approx = wlf_vector4_create(3.00001, 4.00001, 5.00001, 6.00001);
	...
	struct wlf_vector4 ortho1 = wlf_vector4_create(1.0, 0.0, 0.0, 0.0);
	struct wlf_vector4 ortho2 = wlf_vector4_create(0.0, 1.0, 0.0, 0.0);
	...
	struct wlf_vector4 parallel1 = wlf_vector4_create(2.0, 3.0, 4.0, 5.0);
	struct wlf_vector4 parallel2 = wlf_vector4_create(4.0, 6.0, 8.0, 10.0);
	...
	struct wlf_vector4 anti1 = wlf_vector4_create(1.0, 2.0, 3.0, 4.0);
	struct wlf_vector4 anti2 = wlf_vector4_create(-2.0, -4.0, -6.0, -8.0);
	...
	// Very small numbers
	struct wlf_vector4 tiny = wlf_vector4_create(1e-10, 1e-10, 1e-10, 1e-10);
	...
	// Very large numbers
	struct wlf_vector4 large = wlf_vector4_create(1e6, 1e6, 1e6, 1e6);
	...
	struct wlf_vector4 base = wlf_vector4_create(1.0, 2.0, 3.0, 4.0);
	struct wlf_vector4 tiny_diff = wlf_vector4_create(1.0000001, 2.0000001, 3.0000001, 4.0000001);
	struct wlf_vector4 big_diff = wlf_vector4_create(1.1, 2.1, 3.1, 4.1);
	...
	struct wlf_vector4 v3 = wlf_vector4_create(1.0, -1.0, 2.0, -2.0);
	...
	struct wlf_vector4 unit_hypercube_diag = wlf_vector4_create(1.0, 1.0, 1.0, 1.0);
	...
	struct wlf_vector4 point_3d = wlf_vector4_create(3.0, 4.0, 5.0, 1.0);
	// Vector in 3D space represented as 4D homogeneous coordinates (x, y, z, 0)
	struct wlf_vector4 vector_3d = wlf_vector4_create(1.0, 1.0, 1.0, 0.0);
	...
	struct wlf_vector4 quat_like = wlf_vector4_create(0.5, 0.5, 0.5, 0.5);
	...
	struct wlf_vector4 color_red = wlf_vector4_create(1.0, 0.0, 0.0, 1.0);
	struct wlf_vector4 color_green = wlf_vector4_create(0.0, 1.0, 0.0, 0.5);
