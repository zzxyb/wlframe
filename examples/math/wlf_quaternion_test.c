...
static void test_quaternion_creation(void) {
	...
	struct wlf_quaternion q1 = wlf_quaternion_create(1.0, 2.0, 3.0, 4.0);
	...
	struct wlf_quaternion zero = wlf_quaternion_create(0.0, 0.0, 0.0, 0.0);
	...
	struct wlf_quaternion unit = wlf_quaternion_create(1.0, 0.0, 0.0, 0.0);
...
static void test_quaternion_arithmetic(void) {
	...
	struct wlf_quaternion q1 = wlf_quaternion_create(1.0, 2.0, 3.0, 4.0);
	struct wlf_quaternion q2 = wlf_quaternion_create(0.5, 1.5, 2.5, 3.5);

	// Test addition
	struct wlf_quaternion sum = wlf_quaternion_add(&q1, &q2);
	struct wlf_quaternion expected_sum = wlf_quaternion_create(1.5, 3.5, 5.5, 7.5);
	...
	struct wlf_quaternion expected_diff = wlf_quaternion_create(0.5, 0.5, 0.5, 0.5);
	...
	struct wlf_quaternion expected_prod = wlf_quaternion_create(-24.0, 3.0, 3.0, 6.0);
...
static void test_quaternion_conjugate(void) {
	...
	struct wlf_quaternion q = wlf_quaternion_create(1.0, 2.0, 3.0, 4.0);
	struct wlf_quaternion conjugate = wlf_quaternion_conjugate(&q);

	// Conjugate should negate x, y, z components
	struct wlf_quaternion expected_conj = wlf_quaternion_create(1.0, -2.0, -3.0, -4.0);
	...
	struct wlf_quaternion q1 = wlf_quaternion_create(1.0, 1.0, 0.0, 0.0);
	struct wlf_quaternion q2 = wlf_quaternion_create(0.0, 0.0, 1.0, 1.0);
	struct wlf_quaternion prod = wlf_quaternion_multiply(&q1, &q2);
...
static void test_quaternion_norm_and_normalize(void) {
	...
	struct wlf_quaternion scaled_back = wlf_quaternion_create(
...
static void test_quaternion_inverse(void) {
	...
	struct wlf_quaternion temp_q = wlf_quaternion_create(1.0, 1.0, 1.0, 1.0);
	...
	struct wlf_quaternion q = wlf_quaternion_create(2.0, 1.0, 0.0, 0.0);
...
static void test_quaternion_equality(void) {
	...
	// Test exact equality
	struct wlf_quaternion q1 = wlf_quaternion_create(1.0, 2.0, 3.0, 4.0);
	struct wlf_quaternion q2 = wlf_quaternion_create(1.0, 2.0, 3.0, 4.0);
	ASSERT_TRUE(wlf_quaternion_equal(&q1, &q2), "Identical quaternions should be equal");

	// Test inequality
	struct wlf_quaternion q3 = wlf_quaternion_create(1.1, 2.0, 3.0, 4.0);
	ASSERT_TRUE(!wlf_quaternion_equal(&q1, &q3), "Different quaternions should not be equal");

	// Test nearly equal
	struct wlf_quaternion q4 = wlf_quaternion_create(1.0 + 1e-10, 2.0, 3.0, 4.0);
...
static void test_quaternion_mathematical_properties(void) {
	...
	struct wlf_quaternion q1 = wlf_quaternion_create(1.0, 1.0, 0.0, 0.0);
	struct wlf_quaternion q2 = wlf_quaternion_create(0.0, 0.0, 1.0, 1.0);
	struct wlf_quaternion q3 = wlf_quaternion_create(0.5, 0.5, 0.5, 0.5);
...
static void test_quaternion_rotation_properties(void) {
	...
	struct wlf_quaternion rot_z = wlf_quaternion_create(cos(angle), 0.0, 0.0, sin(angle));
	...
	struct wlf_quaternion rot_180_z = wlf_quaternion_create(0.0, 0.0, 0.0, 1.0);
	...
	struct wlf_quaternion neg_identity_rot = wlf_quaternion_create(-1, 0, 0, 0);
...
static void test_quaternion_edge_cases(void) {
	...
	struct wlf_quaternion tiny = wlf_quaternion_create(1e-10, 1e-10, 1e-10, 1e-10);
	...
	struct wlf_quaternion large = wlf_quaternion_create(1e6, 1e6, 1e6, 1e6);
