...
int main(int argc, char *argv[]) {
	...
	struct wlf_vector3 v1 = wlf_vector3_create(3.0, 4.0, 5.0);
	struct wlf_vector3 v2 = wlf_vector3_create(-2.5, 1.5, -3.0);
	...
	struct wlf_vector3 v1_copy = wlf_vector3_create(3.0, 4.0, 5.0);
	struct wlf_vector3 v1_approx = wlf_vector3_create(3.00001, 4.00001, 5.00001);
	...
	struct wlf_vector3 ortho1 = wlf_vector3_create(1.0, 0.0, 0.0);
	struct wlf_vector3 ortho2 = wlf_vector3_create(0.0, 1.0, 0.0);
	...
	struct wlf_vector3 parallel1 = wlf_vector3_create(2.0, 3.0, 4.0);
	struct wlf_vector3 parallel2 = wlf_vector3_create(4.0, 6.0, 8.0);
	...
	struct wlf_vector3 anti1 = wlf_vector3_create(1.0, 2.0, 3.0);
	struct wlf_vector3 anti2 = wlf_vector3_create(-2.0, -4.0, -6.0);
	...
	// Very small numbers
	struct wlf_vector3 tiny = wlf_vector3_create(1e-10, 1e-10, 1e-10);
	...
	// Very large numbers
	struct wlf_vector3 large = wlf_vector3_create(1e6, 1e6, 1e6);
	...
	struct wlf_vector3 base = wlf_vector3_create(1.0, 2.0, 3.0);
	struct wlf_vector3 tiny_diff = wlf_vector3_create(1.0000001, 2.0000001, 3.0000001);
	struct wlf_vector3 big_diff = wlf_vector3_create(1.1, 2.1, 3.1);
	...
	struct wlf_vector3 v3 = wlf_vector3_create(1.0, -1.0, 2.0);
	...
	struct wlf_vector3 vec_345 = wlf_vector3_create(3.0, 4.0, 0.0);
	double mag_345 = wlf_vector3_magnitude(&vec_345);
	wlf_log(WLF_INFO, "Vector(3,4,0) magnitude: %.3f (expected: 5.000)", mag_345);

	// Unit cube diagonal
	struct wlf_vector3 unit_cube_diag = wlf_vector3_create(1.0, 1.0, 1.0);
	...
	struct wlf_vector3 a = wlf_vector3_create(1.0, 2.0, 3.0);
	struct wlf_vector3 b = wlf_vector3_create(4.0, 5.0, 6.0);
	struct wlf_vector3 c = wlf_vector3_create(7.0, 8.0, 9.0);
