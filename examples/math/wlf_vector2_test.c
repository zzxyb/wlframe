...
int main(int argc, char *argv[]) {
	...
	struct wlf_vector2 v1 = wlf_vector2_create(3.0, 4.0);
	struct wlf_vector2 v2 = wlf_vector2_create(-2.5, 1.5);
	...
	struct wlf_vector2 v1_copy = wlf_vector2_create(3.0, 4.0);
	struct wlf_vector2 v1_approx = wlf_vector2_create(3.00001, 4.00001);
	...
	struct wlf_vector2 ortho1 = wlf_vector2_create(1.0, 0.0);
	struct wlf_vector2 ortho2 = wlf_vector2_create(0.0, 1.0);
	...
	struct wlf_vector2 parallel1 = wlf_vector2_create(2.0, 3.0);
	struct wlf_vector2 parallel2 = wlf_vector2_create(4.0, 6.0);
	...
	struct wlf_vector2 anti1 = wlf_vector2_create(1.0, 2.0);
	struct wlf_vector2 anti2 = wlf_vector2_create(-2.0, -4.0);
	...
	// Division by zero
	struct wlf_vector2 div_by_zero = wlf_vector2_divide(&v1, 0.0);
	char *div_zero_str = wlf_vector2_to_str(&div_by_zero);
	wlf_log(WLF_INFO, "v1 / 0.0 = %s (should equal v1)", div_zero_str);
	free(div_zero_str);

	// Very small numbers
	struct wlf_vector2 tiny = wlf_vector2_create(1e-10, 1e-10);
	...
	// Very large numbers
	struct wlf_vector2 large = wlf_vector2_create(1e6, 1e6);
	...
	struct wlf_vector2 base = wlf_vector2_create(1.0, 2.0);
	struct wlf_vector2 tiny_diff = wlf_vector2_create(1.0000001, 2.0000001);
	struct wlf_vector2 big_diff = wlf_vector2_create(1.1, 2.1);
	...
	struct wlf_vector2 v3 = wlf_vector2_create(1.0, -1.0);
	...
	struct wlf_vector2 vec_3_4 = wlf_vector2_create(3.0, 4.0);
	...
	struct wlf_vector2 vec_45_1 = wlf_vector2_create(1.0, 1.0);
	struct wlf_vector2 vec_45_2 = wlf_vector2_create(1.0, 0.0);
