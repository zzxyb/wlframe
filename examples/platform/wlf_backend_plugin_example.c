/**
 * @file        wlf_backend_plugin_example.c
 * @brief       Example backend plugin implementation
 * @details     This is an example of how to create a backend plugin
...
/**
 * @brief Custom backend type for this plugin
 */
#define WLF_BACKEND_EXAMPLE 1000

/**
 * @brief Example backend specific data
 */
