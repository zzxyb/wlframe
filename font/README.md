...
struct wlf_glyph {
    ...
    struct wlf_size size;            // Bitmap dimensions
    struct wlf_point bearing;        // Glyph bearing
    struct wlf_point advance;        // Advance to next glyph
...
### Current (Placeholder)
- Standard C library
- wlframe math utilities (wlf_point, wlf_size, etc.)
