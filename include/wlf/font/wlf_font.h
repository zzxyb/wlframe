...
struct wlf_glyph {
	...
	struct wlf_size size;               /**< Glyph bitmap size */
	struct wlf_point bearing;           /**< Glyph bearing (offset from baseline) */
	struct wlf_point advance;           /**< Advance to next glyph position */
...
struct wlf_font {
	...
	struct wlf_point max_advance;       /**< Maximum advance */
...
struct wlf_text_metrics {
	struct wlf_size size;               /**< Text bounding box size */
