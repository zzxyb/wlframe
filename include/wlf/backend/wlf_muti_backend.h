#ifndef BACKEND_WLF_MULTI_BACKEND_H
#define BACKEND_WLF_MULTI_BACKEND_H
...
struct wlf_multi_backend {
	...
	struct wlf_linked_list backends;

	struct wlf_listener event_loop_destroy;
...
#endif // BACKEND_WLF_MULTI_BACKEND_H
