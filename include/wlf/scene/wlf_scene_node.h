...
struct wlf_scene_node_impl {
	...
	void (*is_tree)(struct wlf_scene_node *node);
	void (*set_enabled)(struct wlf_scene_node *node, bool enabled);
	void (*set_position)(struct wlf_scene_node *node, double x, double y);
	void (*place_above)(struct wlr_scene_node *node,
		struct wlr_scene_node *sibling);
	void (*place_below)(struct wlf_scene_node *node,
		struct wlf_scene_node *sibling);
	void (*raise_to_top)(struct wlr_scene_node *node);
	void (*lower_to_bottom)(struct wlr_scene_node *node);
	void (*reparent)(struct wlr_scene_node *node,
		struct wlr_scene_tree *new_parent);
	struct wlf_linked_list *(*get_children)(struct wlr_scene_node *node);
...
void wlf_scene_node_is_tree(struct wlf_scene_node *node);
...
struct wlf_linked_list *wlr_scene_node_get_children(struct wlf_scene_node *node);
void wlr_scene_node_get_size(struct wlf_scene_node *node,
	double *width, double *height);
