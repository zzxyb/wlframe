 ...
 */
typedef void (*wlf_notify_func_t)(struct wlf_double_listener *listener, void *data);
 ...
 *
 * \code
 * struct wlf_double_listener listener;
 * 
 * // Setup listener
 ...
 *
 * \code
 * void your_callback(struct wlf_double_listener *listener, void *data)
 * {
