...
struct wlf_wl_clipboard {
	...
	struct wlf_backend_wayland *backend; /**< Wayland backend */
 ...
 *
 * @param backend Wayland backend to use.
 * @param seat Wayland seat for input (can be NULL, fallback to backend seat).
