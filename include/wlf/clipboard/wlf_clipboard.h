...
/**
 * @brief Initialize a clipboard object with implementation callbacks.
 *
 * This function initializes caller-owned clipboard storage.
 * It does not allocate memory.
 *
 * @param clipboard Clipboard object to initialize.
 * @param impl Clipboard implementation callbacks.
 */
