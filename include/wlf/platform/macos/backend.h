...
struct wlf_backend_macos {
	...
	bool started;                         /**< AppKit launch sequence completed */
	struct wlf_output_manager *output_manager; /**< Tracks connected displays */
	struct wlf_listener output_added;     /**< Bridges manager output-added events */
	struct wlf_listener output_removed;   /**< Bridges manager output-removed events */
};
