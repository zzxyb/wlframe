...
/**
 * @brief Create a new Wayland client backend
 * @param args Backend creation arguments (optional)
 * @return Pointer to the created backend, or NULL on failure
 */
struct wlf_backend *wlf_backend_wayland_create(void *args);

/**
 * @brief Check if Wayland backend is available
