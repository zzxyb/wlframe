...
enum wlf_keyboard_modifier {
	...
	WLF_MODIFIER_META  = 1 << 4,  /**< Super / Command modifier */
	WLF_MODIFIER_NUM   = 1 << 5,  /**< Num modifier */
    WLF_MODIFIER_ALTGR    = 1 << 6, /**< Right Alt (AltGr) */
    WLF_MODIFIER_SCROLL   = 1 << 7, /**< Scroll Lock */
};
...
struct wlf_keyboard_modifiers {
    uint32_t depressed; /**< Mask of currently depressed modifiers */
    uint32_t latched;   /**< Mask of latched modifiers */
    uint32_t locked;    /**< Mask of locked modifiers */
};
