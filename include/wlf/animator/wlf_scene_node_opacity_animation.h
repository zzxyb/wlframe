/**
 * @file        wlf_scene_node_opacity_animation.h
 * @brief       Opacity animation binding for scene nodes.
 */

#ifndef ANIMATOR_WLF_SCENE_NODE_OPACITY_ANIMATION_H
#define ANIMATOR_WLF_SCENE_NODE_OPACITY_ANIMATION_H

#include "wlf/animator/wlf_double_animation.h"
#include "wlf/scene/wlf_scene_node.h"

extern const struct wlf_animator_job_type WLF_ANIMATOR_JOB_TYPE_SCENE_NODE_OPACITY_ANIMATION;

struct wlf_scene_node_opacity_animation {
...
#endif // ANIMATOR_WLF_SCENE_NODE_OPACITY_ANIMATION_H
