/**
 * @file        wlf_scene_node_x_animation.h
 * @brief       X-position animation binding for scene nodes.
 */

#ifndef ANIMATOR_WLF_SCENE_NODE_X_ANIMATION_H
#define ANIMATOR_WLF_SCENE_NODE_X_ANIMATION_H

#include "wlf/animator/wlf_double_animation.h"
#include "wlf/scene/wlf_scene_node.h"

extern const struct wlf_animator_job_type WLF_ANIMATOR_JOB_TYPE_SCENE_NODE_X_ANIMATION;

struct wlf_scene_node_x_animation {
...
#endif // ANIMATOR_WLF_SCENE_NODE_X_ANIMATION_H
