/**
 * @file        wlf_log.h
 * @brief       Logging utility for wlframe.
 * @details     This file provides logging macros and functions for different verbosity levels,
 *              formatted output, error reporting, and assertions. It supports custom log callbacks,
 *              abort and assert macros, and errno-aware logging. All log messages can include
 *              file and line information for easier debugging.
 * @author      YaoBing Xiao
 * @date        2024-05-20
 * @version     v1.0
 * @par Copyright(c):
...
#ifndef UTILS_WLF_LOG_H
#define UTILS_WLF_LOG_H
