/**
 * @file        wlf_list.h
 * @brief       Dynamic array list utility for wlframe.
 * @details     This file provides a dynamic array-based list implementation.
 *              It supports creation, destruction, insertion, deletion, concatenation,
 *              searching, sorting, swapping, and moving items within the list.
 *              All items are stored as void pointers for generic usage.
 * @author      YaoBing Xiao
 * @date        2024-05-20
 * @version     v1.0
 * @par Copyright(c):
...
#ifndef UTILS_WLF_LIST_H
#define UTILS_WLF_LIST_H

/**
 * @brief Structure representing a dynamic list.
 *
 * The list stores pointers to items and manages its own capacity and length.
 */
struct wlf_list {
