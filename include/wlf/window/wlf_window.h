...
struct wlf_window_impl {
	...
	void (*set_position)(struct wlf_window *window, int x, int y);
	...
	void (*raise)(struct wlf_window *window);
	void (*lower)(struct wlf_window *window);
 ...
 * @param window Pointer to the window.
 */
bool wlf_window_raise(struct wlf_window *window);

/**
 * @brief Lower the window to the bottom.
 * @param window Pointer to the window.
 */
bool wlf_window_lower(struct wlf_window *window);
