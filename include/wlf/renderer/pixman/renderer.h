 ...
 * `wlf_renderer`. It manages a pixman image as the primary rendering surface
 * and exposes CPU-based compositing operations.
 */
struct wlf_pixman_renderer {
	...
	uint32_t width;               /**< Width of the current rendering surface in pixels. */
	uint32_t height;              /**< Height of the current rendering surface in pixels. */

	pixman_image_t *target_image; /**< Pixman image used as the rendering target. */
};
