/**
 * @file        wlf_lame_border_pass.h
 * @brief       Superellipse-border rendering pass interface in wlframe.
 */

#ifndef PASS_WLF_LAME_BORDER_PASS_H
#define PASS_WLF_LAME_BORDER_PASS_H
...
struct wlf_render_lame_border_options {
...
struct wlf_render_lame_border_pass;

struct wlf_render_lame_border_pass_impl {
	void (*destroy)(struct wlf_render_lame_border_pass *pass);
	void (*render)(struct wlf_render_lame_border_pass *pass,
...
#endif // PASS_WLF_LAME_BORDER_PASS_H
