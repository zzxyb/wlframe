...
struct wlf_rect_pass_impl {
	 ...
	 */
	void (*render)(struct wlf_rect_pass *pass,
 ...
 */
struct wlf_rect_pass {
	const struct wlf_rect_pass_impl *impl; /**< Implementation vtable */
	struct {
